    ...
    return (
        <div className="min-vh-100 d-flex align-items-center justify-content-center p-4" style={{ background: 'var(--bg-deep)' }}>
            ...
            <div style={{
                ...
                width: '200%',
                height: '200%',
                background: 'radial-gradient(ellipse at 30% 20%, rgba(124, 58, 237, 0.08) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, rgba(6, 182, 212, 0.05) 0%, transparent 50%)',
                pointerEvents: 'none'
            }} />

            <div className="fade-in" style={{ maxWidth: '440px', width: '100%', position: 'relative' }}>
                {/* Logo */}
                <div className="text-center mb-5">
                    ...
                    <p className="text-muted">Sign in to access your energy command center</p>
                </div>

                {/* Activation Success */}
                {activated && (
                    <div className="mb-4 p-4 rounded-3 d-flex align-items-center gap-3 fade-in" style={{
                        background: 'rgba(16, 185, 129, 0.1)',
                        border: '1px solid rgba(16, 185, 129, 0.2)'
                    }}>
                        <FiCheckCircle style={{ fontSize: '1.5rem', color: '#10b981' }} />
                        <div>
                            <div className="fw-bold" style={{ color: '#10b981' }}>Account Activated!</div>
                ...
                <div className="card" style={{ background: 'var(--bg-surface)', padding: '2.5rem' }}>
                    ...
                    <div className="text-center">
                        ...
                        <Link to="/signup" className="text-gradient fw-bold small" style={{ textDecoration: 'none' }}>
                            Create Account
                        </Link>
                    </div>
                </div>

                <p className="text-center text-muted small mt-4" style={{ opacity: 0.5 }}>
