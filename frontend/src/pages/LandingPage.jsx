    ...
    <div
      ...
      <header
        ...
        <motion.p
          ...
          Join the revolution of smart classrooms. Monitor, control, and
          optimize your energy footprint with our state-of-the-art dashboard.
        </motion.p>
        ...
        <motion.div
          ...
          <div
            style={{
              ...
              overflow: "hidden",
              boxShadow:
                "0 50px 100px -20px rgba(0, 210, 106, 0.3), 0 0 0 1px rgba(255,255,255,0.1)",
              background: "#000",
            }}>
            <img
      ...
      <section style={{ padding: "5rem 5%", background: "var(--bg-elevated)" }}>
        <div style={{ textAlign: "center", marginBottom: "4rem" }}>
          ...
          <p style={{ opacity: 0.7 }}>
            Watch how our system transforms data into actionable savings.
          </p>
        </div>
              ...
              <motion.div
                ...
                {isActive && (
                  <div
                    style={{
                      ...
                      height: "1px",
                      background:
                        "linear-gradient(90deg, transparent, rgba(0, 210, 106, 0.8), transparent)",
                    }}
                  />
                )}
                ...
                <div
                  style={{
                    ...
                    transition: "all 0.3s",
                    boxShadow: isActive
                      ? "0 10px 20px -5px rgba(0, 210, 106, 0.3)"
                      : "none",
                    border: isActive
      ...
      <section
        ...
        <div style={{ maxWidth: "800px", textAlign: "center", zIndex: 2 }}>
          <h2 style={{ fontSize: "2.5rem", marginBottom: "2rem" }}>
            Experience Intelligent Alerts
          </h2>
          <p style={{ marginBottom: "3rem", fontSize: "1.2rem", opacity: 0.8 }}>
            Notifications appear only when you need them. They guide you to shut
            down unused devices and vanish when the job is done.
          </p>
        </div>
      ...
      <footer
        ...
        <p style={{ opacity: 0.5 }}>
          © {new Date().getFullYear()} SmartEnergy. All rights reserved.
        </p>
      </footer>
    </div>
  );
